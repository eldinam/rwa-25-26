// ==========================================================
// -V10 Konekcija sa SQLite bazom podataka
// ==========================================================
// Sve sto je bilo u v9 ostaje. NOVO U V10:
//   - tabela `korisnik` -> registrovani korisnici aplikacije
//     (za login/registraciju). Lozinka se NE cuva u plain
//     tekstu nego kao bcrypt HASH (`password_hash`).
...
db.exec(`
  ...
  -- -V10 NOVO: tabela korisnik (za login/registraciju)
  -- VAZNO: 'password_hash' znaci da NE cuvamo originalnu lozinku!
  -- Cuvamo bcrypt hash iz kojeg je nemoguce vratiti originalnu lozinku.
  -- Tako, ako neko ukrade bazu, ne moze procitati lozinke.
